...
3. **Best subset selection** → Choose which variables to include (BIC)
4. **OLS vs Ridge** → Choose how to estimate coefficients (10-fold CV)
5. Generate predictions with **confidence intervals** to quantify uncertainty
...
# (Ridge predictions don't have built-in CIs, so we use OLS models)
