...
# look at AIC across model sizes
reg_summary_mean$aic

# best model by AIC
best_size <- which.min(reg_summary_mean$aic)
...
best_size <- which.min(reg_summary_var$aic)
cat("Best model size:", best_size, "variables\n")
...
reg_summary_skew$aic

best_size <- which.min(reg_summary_skew$aic)
cat("Best model size:", best_size, "variables\n")
...
reg_summary_kurt$aic

best_size <- which.min(reg_summary_kurt$aic)
cat("Best model size:", best_size, "variables\n")
